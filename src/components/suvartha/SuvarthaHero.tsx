...
export default function SuvarthaHero() {
  return (
    <section id="home" className="relative overflow-hidden min-h-screen flex items-center">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full text-white min-h-screen flex items-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center w-full">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            ...
            <div className="mb-6 sm:mb-8 flex justify-center lg:justify-start">
              <SuvarthaLogo size="xl" variant="light" showText={false} />
            </div>

            {/* Main Heading */}
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight text-white drop-shadow-lg">
              He Replenishes<br />
