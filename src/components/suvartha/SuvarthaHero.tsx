  ...
  return (
    <section id="home" className="relative overflow-hidden min-h-screen flex items-center">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full text-white min-h-screen flex flex-col justify-center items-center text-center">
        ...
        {/* Main Heading */}
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight mb-8 sm:mb-12">
        ...
        <div className="max-w-2xl mx-auto mb-12 sm:mb-16">
          ...
          <div className="mb-6 text-center">
            <div className="inline-block bg-gradient-to-r from-purple-500/30 to-pink-500/30 backdrop-blur-md px-6 py-3 rounded-xl border-2 border-gradient-to-r from-purple-400 to-pink-400 shadow-xl">
              <p className="text-xl sm:text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-orange-400 drop-shadow-lg">
                Galatians 2:20
              </p>
            </div>
          </div>
          ...
          {/* Scripture Quote */}
          <div className="bg-gradient-to-br from-blue-500/25 via-purple-500/25 to-pink-500/25 backdrop-blur-md rounded-2xl p-6 sm:p-8 border-2 border-white/40 shadow-2xl">
            ...
            <div className="mt-6 flex justify-center">
              <div className="w-20 h-1 bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 rounded-full shadow-lg"></div>
            </div>
            <p className="text-sm sm:text-base text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-orange-300 mt-4 font-semibold text-center drop-shadow">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mb-16 sm:mb-20">
          ...
          <button 
            ...
            className="bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white px-6 sm:px-8 md:px-10 py-3 sm:py-4 rounded-full font-semibold text-sm sm:text-base md:text-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 hover:scale-105 w-full sm:w-auto justify-center backdrop-blur-md border-2 border-white/20"
          >
            Find Hope Here
          </button>
        </div>
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
          <div className="w-6 h-10 border-2 border-gradient-to-b from-purple-400 to-pink-400 rounded-full flex justify-center bg-gradient-to-b from-purple-500/20 to-pink-500/20 backdrop-blur-sm shadow-lg">
            <div className="w-1 h-3 bg-gradient-to-b from-yellow-400 to-orange-500 rounded-full mt-2 animate-bounce shadow-lg"></div>
          </div>
        </div>
      </div>
    </section>
