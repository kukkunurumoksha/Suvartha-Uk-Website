    ...
    <section id="home" className="relative overflow-hidden min-h-screen flex items-center">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full text-white min-h-screen flex flex-col justify-between">
        ...
        <div className="pb-4 sm:pb-6">
          {/* CTA Buttons - moved down even further */}
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mb-20 sm:mb-24 px-4 pt-16 sm:pt-20 lg:pt-24">
            <button 
